...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.clusterInfoContainer = QFormLayout()
        self.clusterInfoContainer.setObjectName(u"clusterInfoContainer")
        self.clusterFilenameLabel = QLabel(self.controls_container)
        self.clusterFilenameLabel.setObjectName(u"clusterFilenameLabel")

        self.clusterInfoContainer.setWidget(1, QFormLayout.LabelRole, self.clusterFilenameLabel)

        self.cluseFilename = QLabel(self.controls_container)
        self.cluseFilename.setObjectName(u"cluseFilename")

        self.clusterInfoContainer.setWidget(1, QFormLayout.FieldRole, self.cluseFilename)

        self.clusterSizeLabel = QLabel(self.controls_container)
        self.clusterSizeLabel.setObjectName(u"clusterSizeLabel")

        self.clusterInfoContainer.setWidget(2, QFormLayout.LabelRole, self.clusterSizeLabel)

        self.clusterSize = QLabel(self.controls_container)
        self.clusterSize.setObjectName(u"clusterSize")

        self.clusterInfoContainer.setWidget(2, QFormLayout.FieldRole, self.clusterSize)

        self.projectNameLabel = QLabel(self.controls_container)
        self.projectNameLabel.setObjectName(u"projectNameLabel")

        self.clusterInfoContainer.setWidget(0, QFormLayout.LabelRole, self.projectNameLabel)

        self.projectName = QLabel(self.controls_container)
        self.projectName.setObjectName(u"projectName")

        self.clusterInfoContainer.setWidget(0, QFormLayout.FieldRole, self.projectName)


        self.verticalLayout_3.addLayout(self.clusterInfoContainer)
        ...
        self.menuPreferences.addAction(self.actionData_Storage)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.actionApperance.setText(QCoreApplication.translate("MainWindow", u"Apperance", None))
#if QT_CONFIG(shortcut)
        self.actionApperance.setShortcut(QCoreApplication.translate("MainWindow", u"Ctrl+Shift+A", None))
#endif // QT_CONFIG(shortcut)
        self.actionData_Collection.setText(QCoreApplication.translate("MainWindow", u"Data Collection", None))
#if QT_CONFIG(shortcut)
        ...
        self.clusterFilenameLabel.setText(QCoreApplication.translate("MainWindow", u"Current Cluster Filename: ", None))
        self.cluseFilename.setText("")
        self.clusterSizeLabel.setText(QCoreApplication.translate("MainWindow", u"Cluster Size: ", None))
        self.clusterSize.setText("")
